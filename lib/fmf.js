...
if (debug) {
  // remove the fork directories
  trycode(function () { fs.rmdirSync(resolve(cwd, dir.forks)); });
  trycode(function () { fs.rmdirSync(resolve(cwd, dir.loading)); });
}

trycode(function () { fs.mkdirSync(resolve(cwd, dir.forks)); });
trycode(function () { fs.mkdirSync(resolve(cwd, dir.loading)); });
